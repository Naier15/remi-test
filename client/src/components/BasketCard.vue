<template>
    <div class="card mb-5 rounded-5 shadow">
        ...
        <div class="counter">
            <button @click="$emit('increase', index)" class="reset_btn" type="submit">
                <svg xmlns="http://www.w3.org/2000/svg" width="3rem" height="3rem" fill="currentColor" class="btn btn-success bi bi-plus-circle-dotted radius" viewBox="0 0 16 16">
            ...
            <button @click="$emit('decrease', index)" class="reset_btn" type="submit">
                <svg xmlns="http://www.w3.org/2000/svg" width="3rem" height="3rem" fill="currentColor" class="btn btn-danger bi bi-dash-circle-dotted radius" viewBox="0 0 16 16">
